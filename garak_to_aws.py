...
import paho.mqtt.client as mqtt import serial
import os
import datetime
import calendar
...
ENDPOINT = '''Your ENDPOINT xxxxx.amazonaws.com''''
THING_NAME = 'myPSP'
...
mqtt_client.tls_set(rootca,certfile = cert, keyfile=privatekey, tls_version=ssl.PROTOCOL_TLSv1_2, ciphers=None)
